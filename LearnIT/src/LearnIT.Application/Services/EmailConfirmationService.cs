...
namespace LearnIT.WebUI.Server.Services.EmailService
{
    public class EmailConfirmationService : IEmailConfirmationService
    {
        ...
        public async Task<EmailSendingIssues> SendEmailConfirmationToAsync(int userId)
        {
            ...
            EmailSendResult emailSendResult = await _emailSender.SendEmailWithHtmlBodyAsync(user.Email, "Verify your email", htmlBody);
            return emailSendResult.SendingIssue;
        }
